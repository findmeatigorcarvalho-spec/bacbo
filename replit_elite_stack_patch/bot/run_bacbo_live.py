...
_os.environ.setdefault("LUX_G2_COALITION_TO_G1", "1")
_os.environ.setdefault("OUTBOX_RESULT_LOOKBACK_HOURS", "6")
_os.environ.setdefault("OUTBOX_SIGNAL_LOOKBACK_HOURS", "6")
